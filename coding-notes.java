...
57. Course schedule:  There are a total of n courses you have to take, labeled 0 to n - 1.
...
The input prerequisites is a graph represented by a list of edges, not adjacency matrices.
    ...
    public boolean canFinish(int numCourses, int[][] prerequisites) {
        ...
        // Remove edges of the current node; Add all neighbors to queue if their indegree is 0
        while(!queue.isEmpty()) {
